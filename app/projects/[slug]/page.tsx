  ...
  return (
    <main className="min-h-screen bg-[#f4f1eb]">
      <div className="container-main py-8">
        <a href="/#projects" className="text-xs uppercase tracking-[.18em]">← Back to projects</a>
        <div className="mt-10 grid gap-10 md:grid-cols-[1.1fr_.9fr] md:items-end">
          <div>
            <p className="text-xs uppercase tracking-[.25em] text-[#77736c]">{p.category} · {p.location}</p>
        ...
        <div className="mt-12 overflow-hidden">
          <Image src={p.image_url} alt={p.title} width={1800} height={1200} priority sizes="100vw" className="max-h-[75vh] w-full object-cover" />
        </div>
      </div>
    </main>
  );

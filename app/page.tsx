...
const topics = [
  ["Desain rumah", "Mulai dari kebutuhan keluarga, luas bangunan, jumlah ruang, sampai karakter rumah yang diinginkan."],
  ["Jasa arsitek", "Pahami kapan Anda membutuhkan perencanaan arsitektur dan bagaimana memulai konsultasi tanpa harus sudah memiliki desain."],
  ["Renovasi rumah", "Cari tahu hal-hal yang perlu dipertimbangkan sebelum merenovasi rumah agar perubahan benar-benar menyelesaikan masalah."],
  ["Desain interior", "Pelajari cara membuat interior rumah lebih nyaman, rapi, fungsional, dan sesuai aktivitas penghuninya."],
  ["Ruang usaha", "Perencanaan café, toko, kantor, kos, villa, guest house, dan ruang komersial perlu mempertimbangkan fungsi sekaligus pengalaman pengguna."],
  ["Estimasi biaya", "Gunakan gambaran awal untuk memahami faktor yang memengaruhi biaya desain sebelum masuk ke pembahasan proyek."],
];

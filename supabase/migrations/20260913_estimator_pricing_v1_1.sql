...
ALTER TABLE public.estimator_settings
  ADD COLUMN IF NOT EXISTS minimum_project_fee numeric NOT NULL DEFAULT 0;
...
COMMENT ON COLUMN public.estimator_settings.minimum_project_fee IS
  'Optional customer-facing minimum estimated project fee. 0 disables the floor.';

    ...
    <main className="min-h-screen bg-[#f7f5f0] text-[#181817]">
      <div className="border-b border-[#d5d0c7] bg-[#f7f5f0]/95 px-4 py-3 backdrop-blur sm:px-6">
        <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-3">
          <div>
            <div className="text-[10px] font-semibold uppercase tracking-[0.25em] text-[#4d6b52]">
              RUMAH ARSITEK
            </div>
            <div className="mt-1 text-sm font-semibold">Admin Workspace</div>
          </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-full px-4 py-2 text-xs font-medium transition ${
                tab === "dashboard"
                  ...
                  : "border border-[#d5d0c7] bg-white hover:bg-[#faf9f6]"
              }`}
            >
